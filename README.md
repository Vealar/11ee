...
### Примеры ОС ###
1) По архитектуре компьютера: Windows, macOS, Linux
2) По целевому назначению: Windows Server, Ubuntu Server, CentOS
3) По производительности: Windows 10 Home, Windows 10 Pro, Windows 10 Enterprise
### OC/Унификация/ ###  
